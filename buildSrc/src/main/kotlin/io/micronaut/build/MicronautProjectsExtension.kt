...
abstract class MicronautProjectsExtension(@Inject val initScript: RegularFile) {
    @get:Inject
    ...
    fun report(projectDir: File) = tasks.register("reportFor${projectDir.usableName}", GenerateReport::class.java) {
        ...
        initScript.set(this@MicronautProjectsExtension.initScript)
        projectDirectory.set(projectDir)
        micronautProject.set(projectDir.usableName)
